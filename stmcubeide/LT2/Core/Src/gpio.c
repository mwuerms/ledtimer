...
void MX_GPIO_Init(void)
{
  ...
  /**/
  LL_GPIO_ResetOutputPin(P5_GPIO_Port, P5_Pin);

  /**/
  LL_GPIO_ResetOutputPin(P6_GPIO_Port, P6_Pin);
  ...
  /**/
  LL_GPIO_SetPinPull(ENC_A_GPIO_Port, ENC_A_Pin, LL_GPIO_PULL_NO);

  /**/
  LL_GPIO_SetPinPull(ENC_B_GPIO_Port, ENC_B_Pin, LL_GPIO_PULL_NO);

  /**/
  LL_GPIO_SetPinPull(ENC_BTN_GPIO_Port, ENC_BTN_Pin, LL_GPIO_PULL_NO);

  /**/
  LL_GPIO_SetPinMode(ENC_A_GPIO_Port, ENC_A_Pin, LL_GPIO_MODE_INPUT);

  /**/
  LL_GPIO_SetPinMode(ENC_B_GPIO_Port, ENC_B_Pin, LL_GPIO_MODE_INPUT);

  /**/
  LL_GPIO_SetPinMode(ENC_BTN_GPIO_Port, ENC_BTN_Pin, LL_GPIO_MODE_INPUT);
  ...
  /**/
  GPIO_InitStruct.Pin = VIBRA_Pin;
  GPIO_InitStruct.Mode = LL_GPIO_MODE_OUTPUT;
  GPIO_InitStruct.Speed = LL_GPIO_SPEED_FREQ_LOW;
  GPIO_InitStruct.OutputType = LL_GPIO_OUTPUT_PUSHPULL;
  GPIO_InitStruct.Pull = LL_GPIO_PULL_NO;
  LL_GPIO_Init(VIBRA_GPIO_Port, &GPIO_InitStruct);
